 ...
 * @param triggername
 * @param optional nil or *CommandTriggersApiCommandTriggerWebhookPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
     * @param "XOrgId" (optional.String) - 
@return Triggerreturn
*/

type CommandTriggersApiCommandTriggerWebhookPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *CommandTriggersApiService) CommandTriggerWebhookPost(ctx context.Context, triggername string, localVarOptionals *CommandTriggersApiCommandTriggerWebhookPostOpts) (Triggerreturn, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue Triggerreturn
	)
