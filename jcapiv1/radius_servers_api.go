...
func (a *RadiusServersApiService) RadiusServersDelete(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Radiusserverput,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) 
 @return Radiusserver*/
func (a *RadiusServersApiService) RadiusServersGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Radiusserver,  *http.Response, error) {
	var (
...
func (a *RadiusServersApiService) RadiusServersList(ctx context.Context, localVarOptionals map[string]interface{}) (Radiusserverslist,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) 
 @return Radiusserver*/
func (a *RadiusServersApiService) RadiusServersPost(ctx context.Context, localVarOptionals map[string]interface{}) (Radiusserver,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) 
 @return Radiusserverput*/
func (a *RadiusServersApiService) RadiusServersPut(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Radiusserverput,  *http.Response, error) {
	var (
