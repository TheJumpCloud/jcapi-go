...
/*
SystemsApiService Erase a System
 ...
 * @param systemId
 * @param optional nil or *SystemsApiSystemsCommandBuiltinEraseOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) - 

*/

type SystemsApiSystemsCommandBuiltinEraseOpts struct {
    XOrgId optional.String
}

func (a *SystemsApiService) SystemsCommandBuiltinErase(ctx context.Context, systemId string, localVarOptionals *SystemsApiSystemsCommandBuiltinEraseOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/systems/{system_id}/command/builtin/erase"
...
/*
SystemsApiService Lock a System
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId
 * @param optional nil or *SystemsApiSystemsCommandBuiltinLockOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) - 

*/

type SystemsApiSystemsCommandBuiltinLockOpts struct {
    XOrgId optional.String
}

func (a *SystemsApiService) SystemsCommandBuiltinLock(ctx context.Context, systemId string, localVarOptionals *SystemsApiSystemsCommandBuiltinLockOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/systems/{system_id}/command/builtin/lock"
	localVarPath = strings.Replace(localVarPath, "{"+"system_id"+"}", fmt.Sprintf("%v", systemId), -1)
...
/*
SystemsApiService Restart a System
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId
 * @param optional nil or *SystemsApiSystemsCommandBuiltinRestartOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) - 

*/

type SystemsApiSystemsCommandBuiltinRestartOpts struct {
    XOrgId optional.String
}

func (a *SystemsApiService) SystemsCommandBuiltinRestart(ctx context.Context, systemId string, localVarOptionals *SystemsApiSystemsCommandBuiltinRestartOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/systems/{system_id}/command/builtin/restart"
	localVarPath = strings.Replace(localVarPath, "{"+"system_id"+"}", fmt.Sprintf("%v", systemId), -1)
...
/*
SystemsApiService Shutdown a System
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId
 * @param optional nil or *SystemsApiSystemsCommandBuiltinShutdownOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) - 

*/

type SystemsApiSystemsCommandBuiltinShutdownOpts struct {
    XOrgId optional.String
}

func (a *SystemsApiService) SystemsCommandBuiltinShutdown(ctx context.Context, systemId string, localVarOptionals *SystemsApiSystemsCommandBuiltinShutdownOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/systems/{system_id}/command/builtin/shutdown"
	localVarPath = strings.Replace(localVarPath, "{"+"system_id"+"}", fmt.Sprintf("%v", systemId), -1)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemsApiSystemsDeleteOpts - Optional Parameters:
...
type SystemsApiSystemsDeleteOpts struct {
    Date optional.String
    Authorization optional.String
    XOrgId optional.String
}

func (a *SystemsApiService) SystemsDelete(ctx context.Context, id string, localVarOptionals *SystemsApiSystemsDeleteOpts) (System, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemsApiSystemsGetOpts - Optional Parameters:
...
type SystemsApiSystemsGetOpts struct {
...
func (a *SystemsApiService) SystemsGet(ctx context.Context, id string, localVarOptionals *SystemsApiSystemsGetOpts) (System, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SystemsApiSystemsListOpts - Optional Parameters:
     * @param "Fields" (optional.String) -  Use a space seperated string of field parameters to include the data in the response. If omitted, the default list of fields will be returned. 
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) - 
     * @param "Search" (optional.String) -  A nested object containing a &#x60;searchTerm&#x60; string or array of strings and a list of &#x60;fields&#x60; to search on.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Sort" (optional.String) -  Use space separated sort parameters to sort the collection. Default sort is ascending. Prefix with &#x60;-&#x60; to sort descending. 
     * @param "Filter" (optional.String) -  A filter to apply to the query. See the supported operators below. For more complex searches, see the related &#x60;/search/&lt;domain&gt;&#x60; endpoints, e.g. &#x60;/search/systems&#x60;.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D; Supported operators are: - &#x60;$eq&#x60; (equals) - &#x60;$ne&#x60; (does not equal) - &#x60;$gt&#x60; (is greater than) - &#x60;$gte&#x60; (is greater than or equal to) - &#x60;$lt&#x60; (is less than) - &#x60;$lte&#x60; (is less than or equal to)  _Note: v1 operators differ from v2 operators._  _Note: For v1 operators, excluding the &#x60;$&#x60; will result in undefined behavior._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive.  **Examples** - &#x60;GET /users?filter&#x3D;username:$eq:testuser&#x60; - &#x60;GET /systemusers?filter&#x3D;password_expiration_date:$lte:2021-10-24&#x60; - &#x60;GET /systemusers?filter&#x3D;department:$ne:Accounting&#x60; - &#x60;GET /systems?filter[0]&#x3D;firstname:$eq:foo&amp;filter[1]&#x3D;lastname:$eq:bar&#x60; - this will    AND the filters together. - &#x60;GET /systems?filter[or][0]&#x3D;lastname:$eq:foo&amp;filter[or][1]&#x3D;lastname:$eq:bar&#x60; - this will    OR the filters together.
@return Systemslist
*/

type SystemsApiSystemsListOpts struct {
    Fields optional.String
...
func (a *SystemsApiService) SystemsList(ctx context.Context, localVarOptionals *SystemsApiSystemsListOpts) (Systemslist, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemsApiSystemsPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Systemput) - 
     * @param "Date" (optional.String) -  Current date header for the System Context API
     * @param "Authorization" (optional.String) -  Authorization header for the System Context API
     * @param "XOrgId" (optional.String) - 
@return System
...
type SystemsApiSystemsPutOpts struct {
...
func (a *SystemsApiService) SystemsPut(ctx context.Context, id string, localVarOptionals *SystemsApiSystemsPutOpts) (System, *http.Response, error) {
	var (
