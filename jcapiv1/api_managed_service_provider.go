...
/*
ManagedServiceProviderApiService Administrator TOTP Reset Initiation
This endpoint initiates a TOTP reset for an admin. This request does not accept a body.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id

*/
func (a *ManagedServiceProviderApiService) AdminTotpresetBegin(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/users/resettotp/{id}"
...
/*
ManagedServiceProviderApiService Get Organization Details
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ManagedServiceProviderApiOrganizationListOpts - Optional Parameters:
...
type ManagedServiceProviderApiOrganizationListOpts struct {
...
func (a *ManagedServiceProviderApiService) OrganizationList(ctx context.Context, localVarOptionals *ManagedServiceProviderApiOrganizationListOpts) (Organizationslist, *http.Response, error) {
	var (
...
/*
ManagedServiceProviderApiService Update a user
This endpoint allows you to update a user.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *ManagedServiceProviderApiUsersPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Userput) - 
     * @param "XOrgId" (optional.String) - 
@return Userreturn
*/

type ManagedServiceProviderApiUsersPutOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *ManagedServiceProviderApiService) UsersPut(ctx context.Context, id string, localVarOptionals *ManagedServiceProviderApiUsersPutOpts) (Userreturn, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue Userreturn
	)
...
/*
ManagedServiceProviderApiService Administrator Password Reset Initiation
This endpoint triggers the sending of a reactivation e-mail to an administrator.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id

*/
func (a *ManagedServiceProviderApiService) UsersReactivateGet(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/reactivate/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
