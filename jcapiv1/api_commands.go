 ...
 * @param id
 * @param optional nil or *CommandsApiCommandFileGetOpts - Optional Parameters:
...
type CommandsApiCommandFileGetOpts struct {
...
func (a *CommandsApiService) CommandFileGet(ctx context.Context, id string, localVarOptionals *CommandsApiCommandFileGetOpts) (Commandfilereturn, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *CommandsApiCommandsDeleteOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) - 
@return Command
*/

type CommandsApiCommandsDeleteOpts struct {
    XOrgId optional.String
}

func (a *CommandsApiService) CommandsDelete(ctx context.Context, id string, localVarOptionals *CommandsApiCommandsDeleteOpts) (Command, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *CommandsApiCommandsGetOpts - Optional Parameters:
     * @param "Fields" (optional.String) -  Use a space seperated string of field parameters to include the data in the response. If omitted, the default list of fields will be returned. 
     * @param "XOrgId" (optional.String) - 
@return Command
*/

type CommandsApiCommandsGetOpts struct {
    Fields optional.String
    XOrgId optional.String
}

func (a *CommandsApiService) CommandsGet(ctx context.Context, id string, localVarOptionals *CommandsApiCommandsGetOpts) (Command, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CommandsApiCommandsListOpts - Optional Parameters:
     * @param "Fields" (optional.String) -  Use a space seperated string of field parameters to include the data in the response. If omitted, the default list of fields will be returned. 
...
type CommandsApiCommandsListOpts struct {
    Fields optional.String
...
func (a *CommandsApiService) CommandsList(ctx context.Context, localVarOptionals *CommandsApiCommandsListOpts) (Commandslist, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CommandsApiCommandsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Command) - 
     * @param "XOrgId" (optional.String) - 
@return Command
*/

type CommandsApiCommandsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *CommandsApiService) CommandsPost(ctx context.Context, localVarOptionals *CommandsApiCommandsPostOpts) (Command, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *CommandsApiCommandsPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Command) - 
     * @param "XOrgId" (optional.String) - 
@return Command
*/

type CommandsApiCommandsPutOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *CommandsApiService) CommandsPut(ctx context.Context, id string, localVarOptionals *CommandsApiCommandsPutOpts) (Command, *http.Response, error) {
	var (
