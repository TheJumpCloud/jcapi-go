...
type Organizationsettings struct {
	...
	BetaFeatures *interface{} `json:"betaFeatures,omitempty"`
	...
	DisplayPreferences *OrganizationsettingsDisplayPreferences `json:"displayPreferences,omitempty"`
	...
	GrowthData *interface{} `json:"growthData,omitempty"`
