...
func (a *ManagedServiceProviderApiService) OrganizationList(ctx context.Context, localVarOptionals map[string]interface{}) (Organizationslist,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) 
 @return Userreturn*/
func (a *ManagedServiceProviderApiService) UsersPut(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Userreturn,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  Userreturn
	)
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(Userput); localVarOk {
