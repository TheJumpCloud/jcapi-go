...
/*
ApplicationTemplatesApiService Get an Application Template
 ...
 * @param id
 * @param optional nil or *ApplicationTemplatesApiApplicationTemplatesGetOpts - Optional Parameters:
...
type ApplicationTemplatesApiApplicationTemplatesGetOpts struct {
...
func (a *ApplicationTemplatesApiService) ApplicationTemplatesGet(ctx context.Context, id string, localVarOptionals *ApplicationTemplatesApiApplicationTemplatesGetOpts) (Applicationtemplate, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/application-templates/{id}"
...
/*
ApplicationTemplatesApiService List Application Templates
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ApplicationTemplatesApiApplicationTemplatesListOpts - Optional Parameters:
     * @param "Fields" (optional.String) -  The space separated fields included in the returned records. If omitted the default list of fields will be returned.
     * @param "Limit" (optional.Int32) -  The number of records to return at once.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Sort" (optional.String) -  The space separated fields used to sort the collection. Default sort is ascending, prefix with - to sort descending.
...
type ApplicationTemplatesApiApplicationTemplatesListOpts struct {
    Fields optional.String
    Limit optional.Int32
    Skip optional.Int32
    Sort optional.String
...
func (a *ApplicationTemplatesApiService) ApplicationTemplatesList(ctx context.Context, localVarOptionals *ApplicationTemplatesApiApplicationTemplatesListOpts) (Applicationtemplateslist, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue Applicationtemplateslist
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v Applicationtemplateslist
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
