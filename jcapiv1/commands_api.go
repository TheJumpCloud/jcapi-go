...
func (a *CommandsApiService) CommandFileGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Commandfilereturn,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) 
 @return Command*/
func (a *CommandsApiService) CommandsDelete(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Command,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) 
 @return Command*/
func (a *CommandsApiService) CommandsGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Command,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
...
/* CommandsApiService Get results for a specific command
...
func (a *CommandsApiService) CommandsGetResults(ctx context.Context, id string) ([]Commandresult,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  []Commandresult
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/commands/{id}/results"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return Commandslist*/
func (a *CommandsApiService) CommandsList(ctx context.Context, localVarOptionals map[string]interface{}) (Commandslist,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) 
 @return Command*/
func (a *CommandsApiService) CommandsPost(ctx context.Context, localVarOptionals map[string]interface{}) (Command,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) 
 @return Command*/
func (a *CommandsApiService) CommandsPut(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Command,  *http.Response, error) {
	var (
