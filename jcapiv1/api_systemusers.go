 ...
 * @param systemuserId
 * @param id
 * @param optional nil or *SystemusersApiSshkeyDeleteOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) - 
@return string
*/

type SystemusersApiSshkeyDeleteOpts struct {
    XOrgId optional.String
}

func (a *SystemusersApiService) SshkeyDelete(ctx context.Context, systemuserId string, id string, localVarOptionals *SystemusersApiSshkeyDeleteOpts) (string, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemusersApiSshkeyListOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) - 
@return []Sshkeylist
*/

type SystemusersApiSshkeyListOpts struct {
    XOrgId optional.String
}

func (a *SystemusersApiService) SshkeyList(ctx context.Context, id string, localVarOptionals *SystemusersApiSshkeyListOpts) ([]Sshkeylist, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemusersApiSshkeyPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Sshkeypost) - 
     * @param "XOrgId" (optional.String) - 
@return Sshkeylist
*/

type SystemusersApiSshkeyPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *SystemusersApiService) SshkeyPost(ctx context.Context, id string, localVarOptionals *SystemusersApiSshkeyPostOpts) (Sshkeylist, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemusersApiSystemusersDeleteOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) - 
     * @param "CascadeManager" (optional.String) -  This is an optional flag that can be enabled on the DELETE call, DELETE /systemusers/{id}?cascade_manager&#x3D;null. This parameter will clear the Manager attribute on all direct reports and then delete the account.
@return Systemuserreturn
*/

type SystemusersApiSystemusersDeleteOpts struct {
    XOrgId optional.String
    CascadeManager optional.String
}

func (a *SystemusersApiService) SystemusersDelete(ctx context.Context, id string, localVarOptionals *SystemusersApiSystemusersDeleteOpts) (Systemuserreturn, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.CascadeManager.IsSet() {
		localVarQueryParams.Add("cascade_manager", parameterToString(localVarOptionals.CascadeManager.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemusersApiSystemusersExpireOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) - 
@return string
*/

type SystemusersApiSystemusersExpireOpts struct {
    XOrgId optional.String
}

func (a *SystemusersApiService) SystemusersExpire(ctx context.Context, id string, localVarOptionals *SystemusersApiSystemusersExpireOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemusersApiSystemusersGetOpts - Optional Parameters:
...
type SystemusersApiSystemusersGetOpts struct {
    Fields optional.String
    Filter optional.String
    XOrgId optional.String
}

func (a *SystemusersApiService) SystemusersGet(ctx context.Context, id string, localVarOptionals *SystemusersApiSystemusersGetOpts) (Systemuserreturn, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SystemusersApiSystemusersListOpts - Optional Parameters:
...
type SystemusersApiSystemusersListOpts struct {
...
func (a *SystemusersApiService) SystemusersList(ctx context.Context, localVarOptionals *SystemusersApiSystemusersListOpts) (Systemuserslist, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SystemusersApiSystemusersPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Systemuserputpost) - 
     * @param "XOrgId" (optional.String) - 
     * @param "FullValidationDetails" (optional.String) -  Pass this query parameter when a client wants all validation errors to be returned with a detailed error response for the form field specified. The current form fields are allowed:  * &#x60;password&#x60;  #### Password validation flag Use the &#x60;password&#x60; validation flag to receive details on a possible bad request response &#x60;&#x60;&#x60; ?fullValidationDetails&#x3D;password &#x60;&#x60;&#x60; Without the flag, default behavior will be a normal 400 with only a single validation string error #### Expected Behavior Clients can expect a list of validation error mappings for the validation query field in the details provided on the response: &#x60;&#x60;&#x60; {   \&quot;code\&quot;: 400,   \&quot;message\&quot;: \&quot;Password validation fail\&quot;,   \&quot;status\&quot;: \&quot;INVALID_ARGUMENT\&quot;,   \&quot;details\&quot;: [       {         \&quot;fieldViolationsList\&quot;: [           {\&quot;field\&quot;: \&quot;password\&quot;, \&quot;description\&quot;: \&quot;specialCharacter\&quot;}         ],         &#x27;@type&#x27;: &#x27;type.googleapis.com/google.rpc.BadRequest&#x27;,       },   ], }, &#x60;&#x60;&#x60;
@return Systemuserreturn
*/

type SystemusersApiSystemusersPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
    FullValidationDetails optional.String
}

func (a *SystemusersApiService) SystemusersPost(ctx context.Context, localVarOptionals *SystemusersApiSystemusersPostOpts) (Systemuserreturn, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.FullValidationDetails.IsSet() {
		localVarQueryParams.Add("fullValidationDetails", parameterToString(localVarOptionals.FullValidationDetails.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{"application/json"}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemusersApiSystemusersPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Systemuserput) - 
     * @param "XOrgId" (optional.String) - 
     * @param "FullValidationDetails" (optional.String) -  This endpoint can take in a query when a client wants all validation errors to be returned with error response for the form field specified, i.e. &#x27;password&#x27; #### Password validation flag Use the \&quot;password\&quot; validation flag to receive details on a possible bad request response Without the &#x60;password&#x60; flag, default behavior will be a normal 400 with only a validation string message &#x60;&#x60;&#x60; ?fullValidationDetails&#x3D;password &#x60;&#x60;&#x60; #### Expected Behavior Clients can expect a list of validation error mappings for the validation query field in the details provided on the response: &#x60;&#x60;&#x60; {   \&quot;code\&quot;: 400,   \&quot;message\&quot;: \&quot;Password validation fail\&quot;,   \&quot;status\&quot;: \&quot;INVALID_ARGUMENT\&quot;,   \&quot;details\&quot;: [       {         \&quot;fieldViolationsList\&quot;: [{ \&quot;field\&quot;: \&quot;password\&quot;, \&quot;description\&quot;: \&quot;passwordHistory\&quot; }],         &#x27;@type&#x27;: &#x27;type.googleapis.com/google.rpc.BadRequest&#x27;,       },   ], }, &#x60;&#x60;&#x60;
@return Systemuserreturn
*/

type SystemusersApiSystemusersPutOpts struct {
    Body optional.Interface
    XOrgId optional.String
    FullValidationDetails optional.String
}

func (a *SystemusersApiService) SystemusersPut(ctx context.Context, id string, localVarOptionals *SystemusersApiSystemusersPutOpts) (Systemuserreturn, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemusersApiSystemusersResetmfaOpts - Optional Parameters:
     * @param "Body" (optional.Interface of IdResetmfaBody) - 
     * @param "XOrgId" (optional.String) - 
@return string
*/

type SystemusersApiSystemusersResetmfaOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *SystemusersApiService) SystemusersResetmfa(ctx context.Context, id string, localVarOptionals *SystemusersApiSystemusersResetmfaOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemusersApiSystemusersStateActivateOpts - Optional Parameters:
     * @param "Body" (optional.Interface of StateActivateBody) - 
@return string
*/

type SystemusersApiSystemusersStateActivateOpts struct {
    Body optional.Interface
}

func (a *SystemusersApiService) SystemusersStateActivate(ctx context.Context, id string, localVarOptionals *SystemusersApiSystemusersStateActivateOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *SystemusersApiSystemusersUnlockOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) - 
@return string
*/

type SystemusersApiSystemusersUnlockOpts struct {
    XOrgId optional.String
}

func (a *SystemusersApiService) SystemusersUnlock(ctx context.Context, id string, localVarOptionals *SystemusersApiSystemusersUnlockOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
