...
func (a *CommandResultsApiService) CommandResultsDelete(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Commandresult,  *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/commandresults/{id}"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xOrgId" (string) 
 @return Commandresult*/
func (a *CommandResultsApiService) CommandResultsGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Commandresult,  *http.Response, error) {
	var (
...
/* CommandResultsApiService List all Command Results
...
func (a *CommandResultsApiService) CommandResultsList(ctx context.Context, localVarOptionals map[string]interface{}) (Commandresultslist,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/commandresults"
