...
func (a *CommandTriggersApiService) CommandTriggerWebhookPost(ctx context.Context, triggername string, localVarOptionals map[string]interface{}) (Triggerreturn,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  Triggerreturn
	)
	...
	// body params
	if localVarTempParam, localVarOk := localVarOptionals["body"].(interface{}); localVarOk {
