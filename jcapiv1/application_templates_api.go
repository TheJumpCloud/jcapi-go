...
func (a *ApplicationTemplatesApiService) ApplicationTemplatesGet(ctx context.Context, id string, localVarOptionals map[string]interface{}) (Applicationtemplate,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  Applicationtemplate
	)
...
func (a *ApplicationTemplatesApiService) ApplicationTemplatesList(ctx context.Context, localVarOptionals map[string]interface{}) (Applicationtemplateslist,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  Applicationtemplateslist
	)
