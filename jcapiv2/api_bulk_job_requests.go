...
/*
BulkJobRequestsApiService Create Scheduled Userstate Job
 ...
 * @param optional nil or *BulkJobRequestsApiBulkUserStatesCreateOpts - Optional Parameters:
     * @param "Body" (optional.Interface of BulkScheduledStatechangeCreate) - 
...
type BulkJobRequestsApiBulkUserStatesCreateOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *BulkJobRequestsApiService) BulkUserStatesCreate(ctx context.Context, localVarOptionals *BulkJobRequestsApiBulkUserStatesCreateOpts) ([]ScheduledUserstateResult, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/bulk/userstates"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 201 {
			var v []ScheduledUserstateResult
...
/*
BulkJobRequestsApiService Delete Scheduled Userstate Job
 ...
 * @param optional nil or *BulkJobRequestsApiBulkUserStatesDeleteOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type BulkJobRequestsApiBulkUserStatesDeleteOpts struct {
    XOrgId optional.String
}

func (a *BulkJobRequestsApiService) BulkUserStatesDelete(ctx context.Context, id string, localVarOptionals *BulkJobRequestsApiBulkUserStatesDeleteOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/bulk/userstates/{id}"
...
/*
BulkJobRequestsApiService Gets the next scheduled state change for each user in a list of system users
 ...
 * @param optional nil or *BulkJobRequestsApiBulkUserStatesGetNextScheduledOpts - Optional Parameters:
...
type BulkJobRequestsApiBulkUserStatesGetNextScheduledOpts struct {
    Limit optional.Int32
    Skip optional.Int32
}

func (a *BulkJobRequestsApiService) BulkUserStatesGetNextScheduled(ctx context.Context, users []string, localVarOptionals *BulkJobRequestsApiBulkUserStatesGetNextScheduledOpts) (InlineResponse200, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/bulk/userstates/eventlist/next"
	...
	localVarQueryParams.Add("users", parameterToString(users, "csv"))
...
/*
BulkJobRequestsApiService List Scheduled Userstate Change Jobs
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BulkJobRequestsApiBulkUserStatesListOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     ...
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Userid" (optional.String) -  The systemuser id to filter by.
@return []ScheduledUserstateResult
*/

type BulkJobRequestsApiBulkUserStatesListOpts struct {
    Limit optional.Int32
...
func (a *BulkJobRequestsApiService) BulkUserStatesList(ctx context.Context, localVarOptionals *BulkJobRequestsApiBulkUserStatesListOpts) ([]ScheduledUserstateResult, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BulkJobRequestsApiBulkUsersCreateOpts - Optional Parameters:
     * @param "Body" (optional.Interface of []BulkUserCreate) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "CreationSource" (optional.String) -  Defines the creation-source header for gapps, o365 and workdays requests. If the header isn&#x27;t sent, the default value is &#x60;jumpcloud:bulk&#x60;, if you send the header with a malformed value you receive a 400 error. 
@return JobId
*/

type BulkJobRequestsApiBulkUsersCreateOpts struct {
    Body optional.Interface
    XOrgId optional.String
    CreationSource optional.String
}

func (a *BulkJobRequestsApiService) BulkUsersCreate(ctx context.Context, localVarOptionals *BulkJobRequestsApiBulkUsersCreateOpts) (JobId, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.CreationSource.IsSet() {
		localVarHeaderParams["creation-source"] = parameterToString(localVarOptionals.CreationSource.Value(), "")
	}
	// body params
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param jobId
 * @param optional nil or *BulkJobRequestsApiBulkUsersCreateResultsOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
...
type BulkJobRequestsApiBulkUsersCreateResultsOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *BulkJobRequestsApiService) BulkUsersCreateResults(ctx context.Context, jobId string, localVarOptionals *BulkJobRequestsApiBulkUsersCreateResultsOpts) ([]JobWorkresult, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *BulkJobRequestsApiBulkUsersUpdateOpts - Optional Parameters:
     * @param "Body" (optional.Interface of []BulkUserUpdate) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return JobId
*/

type BulkJobRequestsApiBulkUsersUpdateOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *BulkJobRequestsApiService) BulkUsersUpdate(ctx context.Context, localVarOptionals *BulkJobRequestsApiBulkUsersUpdateOpts) (JobId, *http.Response, error) {
	var (
