 ...
 * @param optional nil or *Office365ApiGraphOffice365AssociationsListOpts - Optional Parameters:
...
type Office365ApiGraphOffice365AssociationsListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *Office365ApiService) GraphOffice365AssociationsList(ctx context.Context, office365Id string, targets []string, localVarOptionals *Office365ApiGraphOffice365AssociationsListOpts) ([]GraphConnection, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param office365Id ObjectID of the Office 365 instance.
 * @param optional nil or *Office365ApiGraphOffice365AssociationsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationOffice365) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type Office365ApiGraphOffice365AssociationsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *Office365ApiService) GraphOffice365AssociationsPost(ctx context.Context, office365Id string, localVarOptionals *Office365ApiGraphOffice365AssociationsPostOpts) (*http.Response, error) {
	var (
 ...
 * @param optional nil or *Office365ApiGraphOffice365TraverseUserOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
...
type Office365ApiGraphOffice365TraverseUserOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
...
func (a *Office365ApiService) GraphOffice365TraverseUser(ctx context.Context, office365Id string, localVarOptionals *Office365ApiGraphOffice365TraverseUserOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param office365Id ObjectID of the Office 365 suite.
 * @param optional nil or *Office365ApiGraphOffice365TraverseUserGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type Office365ApiGraphOffice365TraverseUserGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *Office365ApiService) GraphOffice365TraverseUserGroup(ctx context.Context, office365Id string, localVarOptionals *Office365ApiGraphOffice365TraverseUserGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
Office365ApiService Get Office 365 instance
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param office365Id ObjectID of the Office 365 instance.
 * @param optional nil or *Office365ApiOffice365sGetOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return Office365Output
*/

type Office365ApiOffice365sGetOpts struct {
    XOrgId optional.String
}

func (a *Office365ApiService) Office365sGet(ctx context.Context, office365Id string, localVarOptionals *Office365ApiOffice365sGetOpts) (Office365Output, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue Office365Output
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/office365s/{office365_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"office365_id"+"}", fmt.Sprintf("%v", office365Id), -1)
...
/*
Office365ApiService Get a list of users to import from an Office 365 instance
Lists Office 365 users available for import.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param office365Id
 * @param optional nil or *Office365ApiOffice365sListImportUsersOpts - Optional Parameters:
     * @param "ConsistencyLevel" (optional.String) -  Defines the consistency header for O365 requests. See https://docs.microsoft.com/en-us/graph/api/user-list?view&#x3D;graph-rest-1.0&amp;tabs&#x3D;http#request-headers
     * @param "Top" (optional.Int32) -  Office 365 API maximum number of results per page. See https://docs.microsoft.com/en-us/graph/paging.
     * @param "SkipToken" (optional.String) -  Office 365 API token used to access the next page of results. See https://docs.microsoft.com/en-us/graph/paging.
     * @param "Filter" (optional.String) -  Office 365 API filter parameter. See https://docs.microsoft.com/en-us/graph/api/user-list?view&#x3D;graph-rest-1.0&amp;tabs&#x3D;http#optional-query-parameters.
     * @param "Search" (optional.String) -  Office 365 API search parameter. See https://docs.microsoft.com/en-us/graph/api/user-list?view&#x3D;graph-rest-1.0&amp;tabs&#x3D;http#optional-query-parameters.
     * @param "Orderby" (optional.String) -  Office 365 API orderby parameter. See https://docs.microsoft.com/en-us/graph/api/user-list?view&#x3D;graph-rest-1.0&amp;tabs&#x3D;http#optional-query-parameters.
     * @param "Count" (optional.Bool) -  Office 365 API count parameter. See https://docs.microsoft.com/en-us/graph/api/user-list?view&#x3D;graph-rest-1.0&amp;tabs&#x3D;http#optional-query-parameters.
@return InlineResponse20011
*/

type Office365ApiOffice365sListImportUsersOpts struct {
    ConsistencyLevel optional.String
    Top optional.Int32
...
func (a *Office365ApiService) Office365sListImportUsers(ctx context.Context, office365Id string, localVarOptionals *Office365ApiOffice365sListImportUsersOpts) (InlineResponse20011, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/office365s/{office365_id}/import/users"
	localVarPath = strings.Replace(localVarPath, "{"+"office365_id"+"}", fmt.Sprintf("%v", office365Id), -1)
	...
	if localVarOptionals != nil && localVarOptionals.ConsistencyLevel.IsSet() {
		localVarHeaderParams["ConsistencyLevel"] = parameterToString(localVarOptionals.ConsistencyLevel.Value(), "")
	}
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
...
/*
Office365ApiService Update existing Office 365 instance.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param office365Id ObjectID of the Office 365 instance.
 * @param optional nil or *Office365ApiOffice365sPatchOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Office365PatchInput) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return Office365Output
*/

type Office365ApiOffice365sPatchOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *Office365ApiService) Office365sPatch(ctx context.Context, office365Id string, localVarOptionals *Office365ApiOffice365sPatchOpts) (Office365Output, *http.Response, error) {
	var (
...
*/
func (a *Office365ApiService) TranslationRulesOffice365Delete(ctx context.Context, office365Id string, id string) (*http.Response, error) {
	var (
...
*/
func (a *Office365ApiService) TranslationRulesOffice365Get(ctx context.Context, office365Id string, id string) (Office365TranslationRule, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v Office365TranslationRule
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param office365Id
 * @param optional nil or *Office365ApiTranslationRulesOffice365ListOpts - Optional Parameters:
...
type Office365ApiTranslationRulesOffice365ListOpts struct {
...
func (a *Office365ApiService) TranslationRulesOffice365List(ctx context.Context, office365Id string, localVarOptionals *Office365ApiTranslationRulesOffice365ListOpts) ([]Office365TranslationRule, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param office365Id
 * @param optional nil or *Office365ApiTranslationRulesOffice365PostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Office365TranslationRuleRequest) - 
@return Office365TranslationRule
*/

type Office365ApiTranslationRulesOffice365PostOpts struct {
    Body optional.Interface
}

func (a *Office365ApiService) TranslationRulesOffice365Post(ctx context.Context, office365Id string, localVarOptionals *Office365ApiTranslationRulesOffice365PostOpts) (Office365TranslationRule, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
