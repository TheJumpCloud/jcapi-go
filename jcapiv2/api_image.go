...
/*
ImageApiService Delete application image
Deletes the specified image from an application
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId
 * @param optional nil or *ImageApiApplicationsDeleteLogoOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type ImageApiApplicationsDeleteLogoOpts struct {
    XOrgId optional.String
}

func (a *ImageApiService) ApplicationsDeleteLogo(ctx context.Context, applicationId string, localVarOptionals *ImageApiApplicationsDeleteLogoOpts) (*http.Response, error) {
	var (
