...
/*
CommandResultsApiService List all Command Results by Workflow
 ...
 * @param optional nil or *CommandResultsApiCommandsListResultsByWorkflowOpts - Optional Parameters:
...
type CommandResultsApiCommandsListResultsByWorkflowOpts struct {
...
func (a *CommandResultsApiService) CommandsListResultsByWorkflow(ctx context.Context, localVarOptionals *CommandResultsApiCommandsListResultsByWorkflowOpts) (CommandResultList, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CommandResultList
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/commandresult/workflows"
