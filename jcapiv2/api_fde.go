 ...
 * @param systemId
 * @param optional nil or *FdeApiSystemsGetFDEKeyOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return Systemfdekey
*/

type FdeApiSystemsGetFDEKeyOpts struct {
    XOrgId optional.String
}

func (a *FdeApiService) SystemsGetFDEKey(ctx context.Context, systemId string, localVarOptionals *FdeApiSystemsGetFDEKeyOpts) (Systemfdekey, *http.Response, error) {
	var (
