...
type SCIMImportApiService service
/*
SCIMImportApiService Get a list of users to import from an Application IdM service provider
 ...
 * @param optional nil or *SCIMImportApiImportUsersOpts - Optional Parameters:
...
type SCIMImportApiImportUsersOpts struct {
...
func (a *SCIMImportApiService) ImportUsers(ctx context.Context, applicationId string, localVarOptionals *SCIMImportApiImportUsersOpts) (ImportUsersResponse, *http.Response, error) {
	var (
