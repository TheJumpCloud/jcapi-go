...
type RADIUSServersApi struct {
	Configuration *Configuration
}

func NewRADIUSServersApi() *RADIUSServersApi {
	configuration := NewConfiguration()
	return &RADIUSServersApi{
		Configuration: configuration,
	}
}

func NewRADIUSServersApiWithBasePath(basePath string) *RADIUSServersApi {
	configuration := NewConfiguration()
 ...
 */
func (a RADIUSServersApi) GraphRadiusServerAssociationsList(radiusserverId string, targets []string, contentType string, accept string, limit int32, skip int32) ([]GraphConnection, *APIResponse, error) {
 ...
 * @return void
 */
func (a RADIUSServersApi) GraphRadiusServerAssociationsPost(radiusserverId string, contentType string, accept string, body GraphManagementReq) (*APIResponse, error) {
 ...
 */
func (a RADIUSServersApi) GraphRadiusServerTraverseUser(radiusserverId string, contentType string, accept string, limit int32, skip int32) ([]GraphObjectWithPaths, *APIResponse, error) {
 ...
 * @return []GraphObjectWithPaths
 */
func (a RADIUSServersApi) GraphRadiusServerTraverseUserGroup(radiusserverId string, contentType string, accept string, limit int32, skip int32) ([]GraphObjectWithPaths, *APIResponse, error) {
