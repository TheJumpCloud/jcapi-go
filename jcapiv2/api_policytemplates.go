 ...
 * @param optional nil or *PolicytemplatesApiPolicytemplatesGetOpts - Optional Parameters:
...
type PolicytemplatesApiPolicytemplatesGetOpts struct {
    XOrgId optional.String
}

func (a *PolicytemplatesApiService) PolicytemplatesGet(ctx context.Context, id string, localVarOptionals *PolicytemplatesApiPolicytemplatesGetOpts) (PolicyTemplateWithDetails, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PolicytemplatesApiPolicytemplatesListOpts - Optional Parameters:
...
type PolicytemplatesApiPolicytemplatesListOpts struct {
...
func (a *PolicytemplatesApiService) PolicytemplatesList(ctx context.Context, localVarOptionals *PolicytemplatesApiPolicytemplatesListOpts) ([]PolicyTemplate, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
