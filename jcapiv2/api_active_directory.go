 ...
 * @param agentId
 * @param optional nil or *ActiveDirectoryApiActivedirectoriesAgentsDeleteOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type ActiveDirectoryApiActivedirectoriesAgentsDeleteOpts struct {
    XOrgId optional.String
}

func (a *ActiveDirectoryApiService) ActivedirectoriesAgentsDelete(ctx context.Context, activedirectoryId string, agentId string, localVarOptionals *ActiveDirectoryApiActivedirectoriesAgentsDeleteOpts) (*http.Response, error) {
	var (
 ...
 * @param activedirectoryId
 * @param agentId
 * @param optional nil or *ActiveDirectoryApiActivedirectoriesAgentsGetOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return ActiveDirectoryAgentListOutput
*/

type ActiveDirectoryApiActivedirectoriesAgentsGetOpts struct {
    XOrgId optional.String
}

func (a *ActiveDirectoryApiService) ActivedirectoriesAgentsGet(ctx context.Context, activedirectoryId string, agentId string, localVarOptionals *ActiveDirectoryApiActivedirectoriesAgentsGetOpts) (ActiveDirectoryAgentListOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ActiveDirectoryAgentListOutput
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ActiveDirectoryAgentListOutput
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param activedirectoryId
 * @param optional nil or *ActiveDirectoryApiActivedirectoriesAgentsListOpts - Optional Parameters:
...
type ActiveDirectoryApiActivedirectoriesAgentsListOpts struct {
...
func (a *ActiveDirectoryApiService) ActivedirectoriesAgentsList(ctx context.Context, activedirectoryId string, localVarOptionals *ActiveDirectoryApiActivedirectoriesAgentsListOpts) ([]ActiveDirectoryAgentListOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param activedirectoryId
 * @param optional nil or *ActiveDirectoryApiActivedirectoriesAgentsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ActiveDirectoryAgentInput) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return ActiveDirectoryAgentGetOutput
*/

type ActiveDirectoryApiActivedirectoriesAgentsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *ActiveDirectoryApiService) ActivedirectoriesAgentsPost(ctx context.Context, activedirectoryId string, localVarOptionals *ActiveDirectoryApiActivedirectoriesAgentsPostOpts) (ActiveDirectoryAgentGetOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ActiveDirectoryAgentGetOutput
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 201 {
			var v ActiveDirectoryAgentGetOutput
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param optional nil or *ActiveDirectoryApiActivedirectoriesDeleteOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return ActiveDirectoryOutput
*/

type ActiveDirectoryApiActivedirectoriesDeleteOpts struct {
    XOrgId optional.String
}

func (a *ActiveDirectoryApiService) ActivedirectoriesDelete(ctx context.Context, id string, localVarOptionals *ActiveDirectoryApiActivedirectoriesDeleteOpts) (ActiveDirectoryOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ActiveDirectoryOutput
	)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id ObjectID of this Active Directory instance.
 * @param optional nil or *ActiveDirectoryApiActivedirectoriesGetOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return ActiveDirectoryOutput
*/

type ActiveDirectoryApiActivedirectoriesGetOpts struct {
    XOrgId optional.String
}

func (a *ActiveDirectoryApiService) ActivedirectoriesGet(ctx context.Context, id string, localVarOptionals *ActiveDirectoryApiActivedirectoriesGetOpts) (ActiveDirectoryOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ActiveDirectoryApiActivedirectoriesListOpts - Optional Parameters:
...
type ActiveDirectoryApiActivedirectoriesListOpts struct {
...
func (a *ActiveDirectoryApiService) ActivedirectoriesList(ctx context.Context, localVarOptionals *ActiveDirectoryApiActivedirectoriesListOpts) ([]ActiveDirectoryOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ActiveDirectoryApiActivedirectoriesPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ActiveDirectoryInput) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return ActiveDirectoryOutput
*/

type ActiveDirectoryApiActivedirectoriesPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *ActiveDirectoryApiService) ActivedirectoriesPost(ctx context.Context, localVarOptionals *ActiveDirectoryApiActivedirectoriesPostOpts) (ActiveDirectoryOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *ActiveDirectoryApiGraphActiveDirectoryAssociationsListOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
...
type ActiveDirectoryApiGraphActiveDirectoryAssociationsListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *ActiveDirectoryApiService) GraphActiveDirectoryAssociationsList(ctx context.Context, activedirectoryId string, targets []string, localVarOptionals *ActiveDirectoryApiGraphActiveDirectoryAssociationsListOpts) ([]GraphConnection, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param activedirectoryId
 * @param optional nil or *ActiveDirectoryApiGraphActiveDirectoryAssociationsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationActiveDirectory) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type ActiveDirectoryApiGraphActiveDirectoryAssociationsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *ActiveDirectoryApiService) GraphActiveDirectoryAssociationsPost(ctx context.Context, activedirectoryId string, localVarOptionals *ActiveDirectoryApiGraphActiveDirectoryAssociationsPostOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ActiveDirectoryApiService List the Users bound to an Active Directory instance
 ...
 * @param optional nil or *ActiveDirectoryApiGraphActiveDirectoryTraverseUserOpts - Optional Parameters:
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
...
type ActiveDirectoryApiGraphActiveDirectoryTraverseUserOpts struct {
    Filter optional.Interface
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
...
func (a *ActiveDirectoryApiService) GraphActiveDirectoryTraverseUser(ctx context.Context, activedirectoryId string, localVarOptionals *ActiveDirectoryApiGraphActiveDirectoryTraverseUserOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param activedirectoryId ObjectID of the Active Directory instance.
 * @param optional nil or *ActiveDirectoryApiGraphActiveDirectoryTraverseUserGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type ActiveDirectoryApiGraphActiveDirectoryTraverseUserGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *ActiveDirectoryApiService) GraphActiveDirectoryTraverseUserGroup(ctx context.Context, activedirectoryId string, localVarOptionals *ActiveDirectoryApiGraphActiveDirectoryTraverseUserGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
