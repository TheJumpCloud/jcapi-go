...
/*
PolicyGroupAssociationsApiService List the associations of a Policy Group.
 ...
 * @param optional nil or *PolicyGroupAssociationsApiGraphPolicyGroupAssociationsListOpts - Optional Parameters:
...
type PolicyGroupAssociationsApiGraphPolicyGroupAssociationsListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *PolicyGroupAssociationsApiService) GraphPolicyGroupAssociationsList(ctx context.Context, groupId string, targets []string, localVarOptionals *PolicyGroupAssociationsApiGraphPolicyGroupAssociationsListOpts) ([]GraphConnection, *http.Response, error) {
	var (
...
/*
PolicyGroupAssociationsApiService Manage the associations of a Policy Group
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the Policy Group.
 * @param optional nil or *PolicyGroupAssociationsApiGraphPolicyGroupAssociationsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationPolicyGroup) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type PolicyGroupAssociationsApiGraphPolicyGroupAssociationsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *PolicyGroupAssociationsApiService) GraphPolicyGroupAssociationsPost(ctx context.Context, groupId string, localVarOptionals *PolicyGroupAssociationsApiGraphPolicyGroupAssociationsPostOpts) (*http.Response, error) {
	var (
...
/*
PolicyGroupAssociationsApiService List the Systems bound to a Policy Group
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the Policy Group.
 * @param optional nil or *PolicyGroupAssociationsApiGraphPolicyGroupTraverseSystemOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
...
type PolicyGroupAssociationsApiGraphPolicyGroupTraverseSystemOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
...
func (a *PolicyGroupAssociationsApiService) GraphPolicyGroupTraverseSystem(ctx context.Context, groupId string, localVarOptionals *PolicyGroupAssociationsApiGraphPolicyGroupTraverseSystemOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
PolicyGroupAssociationsApiService List the System Groups bound to Policy Groups
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the Policy Group.
 * @param optional nil or *PolicyGroupAssociationsApiGraphPolicyGroupTraverseSystemGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type PolicyGroupAssociationsApiGraphPolicyGroupTraverseSystemGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *PolicyGroupAssociationsApiService) GraphPolicyGroupTraverseSystemGroup(ctx context.Context, groupId string, localVarOptionals *PolicyGroupAssociationsApiGraphPolicyGroupTraverseSystemGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
