...
type PolicyGroupMembersMembershipApiService service
/*
PolicyGroupMembersMembershipApiService List the members of a Policy Group
 ...
 * @param optional nil or *PolicyGroupMembersMembershipApiGraphPolicyGroupMembersListOpts - Optional Parameters:
...
type PolicyGroupMembersMembershipApiGraphPolicyGroupMembersListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *PolicyGroupMembersMembershipApiService) GraphPolicyGroupMembersList(ctx context.Context, groupId string, localVarOptionals *PolicyGroupMembersMembershipApiGraphPolicyGroupMembersListOpts) ([]GraphConnection, *http.Response, error) {
	var (
...
/*
PolicyGroupMembersMembershipApiService Manage the members of a Policy Group
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the Policy Group.
 * @param optional nil or *PolicyGroupMembersMembershipApiGraphPolicyGroupMembersPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationPolicyGroupMember) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type PolicyGroupMembersMembershipApiGraphPolicyGroupMembersPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *PolicyGroupMembersMembershipApiService) GraphPolicyGroupMembersPost(ctx context.Context, groupId string, localVarOptionals *PolicyGroupMembersMembershipApiGraphPolicyGroupMembersPostOpts) (*http.Response, error) {
	var (
...
/*
PolicyGroupMembersMembershipApiService List the Policy Group&#x27;s membership
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the Policy Group.
 * @param optional nil or *PolicyGroupMembersMembershipApiGraphPolicyGroupMembershipOpts - Optional Parameters:
...
type PolicyGroupMembersMembershipApiGraphPolicyGroupMembershipOpts struct {
...
func (a *PolicyGroupMembersMembershipApiService) GraphPolicyGroupMembership(ctx context.Context, groupId string, localVarOptionals *PolicyGroupMembersMembershipApiGraphPolicyGroupMembershipOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
