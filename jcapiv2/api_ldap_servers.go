 ...
 * @param optional nil or *LDAPServersApiGraphLdapServerAssociationsListOpts - Optional Parameters:
...
type LDAPServersApiGraphLdapServerAssociationsListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *LDAPServersApiService) GraphLdapServerAssociationsList(ctx context.Context, ldapserverId string, targets []string, localVarOptionals *LDAPServersApiGraphLdapServerAssociationsListOpts) ([]GraphConnection, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ldapserverId ObjectID of the LDAP Server.
 * @param optional nil or *LDAPServersApiGraphLdapServerAssociationsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationLdapServer) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type LDAPServersApiGraphLdapServerAssociationsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *LDAPServersApiService) GraphLdapServerAssociationsPost(ctx context.Context, ldapserverId string, localVarOptionals *LDAPServersApiGraphLdapServerAssociationsPostOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ldapserverId ObjectID of the LDAP Server.
 * @param optional nil or *LDAPServersApiGraphLdapServerTraverseUserOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
...
type LDAPServersApiGraphLdapServerTraverseUserOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
...
func (a *LDAPServersApiService) GraphLdapServerTraverseUser(ctx context.Context, ldapserverId string, localVarOptionals *LDAPServersApiGraphLdapServerTraverseUserOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ldapserverId ObjectID of the LDAP Server.
 * @param optional nil or *LDAPServersApiGraphLdapServerTraverseUserGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type LDAPServersApiGraphLdapServerTraverseUserGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *LDAPServersApiService) GraphLdapServerTraverseUserGroup(ctx context.Context, ldapserverId string, localVarOptionals *LDAPServersApiGraphLdapServerTraverseUserGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *LDAPServersApiLdapserversGetOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return LdapServerOutput
*/

type LDAPServersApiLdapserversGetOpts struct {
    XOrgId optional.String
}

func (a *LDAPServersApiService) LdapserversGet(ctx context.Context, id string, localVarOptionals *LDAPServersApiLdapserversGetOpts) (LdapServerOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue LdapServerOutput
	)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *LDAPServersApiLdapserversListOpts - Optional Parameters:
...
type LDAPServersApiLdapserversListOpts struct {
...
func (a *LDAPServersApiService) LdapserversList(ctx context.Context, localVarOptionals *LDAPServersApiLdapserversListOpts) ([]LdapServerOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Unique identifier of the LDAP server.
 * @param optional nil or *LDAPServersApiLdapserversPatchOpts - Optional Parameters:
     * @param "Body" (optional.Interface of LdapserversIdBody) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return InlineResponse20010
*/

type LDAPServersApiLdapserversPatchOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *LDAPServersApiService) LdapserversPatch(ctx context.Context, id string, localVarOptionals *LDAPServersApiLdapserversPatchOpts) (InlineResponse20010, *http.Response, error) {
	var (
