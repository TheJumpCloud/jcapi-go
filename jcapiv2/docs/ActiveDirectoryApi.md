...
> ActivedirectoriesAgentsDelete(ctx, activedirectoryId, agentId, contentType, accept, optional)
...
> ActiveDirectoryAgentListOutput ActivedirectoriesAgentsGet(ctx, activedirectoryId, agentId, contentType, accept, optional)
...
> []ActiveDirectoryAgentListOutput ActivedirectoriesAgentsList(ctx, activedirectoryId, contentType, accept, optional)
...
> ActiveDirectoryAgentGetOutput ActivedirectoriesAgentsPost(ctx, activedirectoryId, contentType, accept, optional)
 ...
 **contentType** | **string**|  | [default to application/json]
 **accept** | **string**|  | [default to application/json]
 **body** | [**ActiveDirectoryAgentInput**](ActiveDirectoryAgentInput.md)|  | 
 **xOrgId** | **string**|  | [default to ]
