...
type Office365Api struct {
	Configuration *Configuration
}

func NewOffice365Api() *Office365Api {
...
func NewOffice365ApiWithBasePath(basePath string) *Office365Api {
	configuration := NewConfiguration()
 ...
 */
func (a Office365Api) GraphOffice365AssociationsList(office365Id string, targets []string, contentType string, accept string, limit int32, skip int32) ([]GraphConnection, *APIResponse, error) {
 ...
 * @return void
 */
func (a Office365Api) GraphOffice365AssociationsPost(office365Id string, contentType string, accept string, body GraphManagementReq) (*APIResponse, error) {
 ...
 */
func (a Office365Api) GraphOffice365TraverseUser(office365Id string, contentType string, accept string, limit int32, skip int32) ([]GraphObjectWithPaths, *APIResponse, error) {
 ...
 * @return []GraphObjectWithPaths
 */
func (a Office365Api) GraphOffice365TraverseUserGroup(office365Id string, contentType string, accept string, limit int32, skip int32) ([]GraphObjectWithPaths, *APIResponse, error) {
