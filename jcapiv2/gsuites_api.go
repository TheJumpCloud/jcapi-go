...
type GsuitesApi struct {
	Configuration *Configuration
}

func NewGsuitesApi() *GsuitesApi {
...
func NewGsuitesApiWithBasePath(basePath string) *GsuitesApi {
	configuration := NewConfiguration()
 ...
 */
func (a GsuitesApi) GraphGSuiteAssociationsList(gsuiteId string, targets []string, contentType string, accept string, limit int32, skip int32) ([]GraphConnection, *APIResponse, error) {
 ...
 * @return void
 */
func (a GsuitesApi) GraphGSuiteAssociationsPost(gsuiteId string, body GraphManagementReq) (*APIResponse, error) {
 ...
 */
func (a GsuitesApi) GraphGSuiteTraverseUser(gsuiteId string, contentType string, accept string, limit int32, skip int32) ([]GraphObjectWithPaths, *APIResponse, error) {
 ...
 * @return []GraphObjectWithPaths
 */
func (a GsuitesApi) GraphGSuiteTraverseUserGroup(gsuiteId string, contentType string, accept string, limit int32, skip int32) ([]GraphObjectWithPaths, *APIResponse, error) {
