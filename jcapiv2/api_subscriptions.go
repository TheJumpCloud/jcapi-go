...
/*
SubscriptionsApiService Lists all the Pricing &amp; Packaging Subscriptions
...
@return []Subscription
*/
func (a *SubscriptionsApiService) SubscriptionsGet(ctx context.Context) ([]Subscription, *http.Response, error) {
	var (
