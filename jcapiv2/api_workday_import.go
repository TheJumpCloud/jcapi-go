 ...
 * @param workdayId
 * @param optional nil or *WorkdayImportApiWorkdaysAuthorizeOpts - Optional Parameters:
     * @param "Body" (optional.Interface of AuthInputObject) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type WorkdayImportApiWorkdaysAuthorizeOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *WorkdayImportApiService) WorkdaysAuthorize(ctx context.Context, workdayId string, localVarOptionals *WorkdayImportApiWorkdaysAuthorizeOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param workdayId
 * @param optional nil or *WorkdayImportApiWorkdaysDeauthorizeOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type WorkdayImportApiWorkdaysDeauthorizeOpts struct {
    XOrgId optional.String
}

func (a *WorkdayImportApiService) WorkdaysDeauthorize(ctx context.Context, workdayId string, localVarOptionals *WorkdayImportApiWorkdaysDeauthorizeOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *WorkdayImportApiWorkdaysGetOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return WorkdayOutput
*/

type WorkdayImportApiWorkdaysGetOpts struct {
    XOrgId optional.String
}

func (a *WorkdayImportApiService) WorkdaysGet(ctx context.Context, id string, localVarOptionals *WorkdayImportApiWorkdaysGetOpts) (WorkdayOutput, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param workdayId
 * @param optional nil or *WorkdayImportApiWorkdaysImportOpts - Optional Parameters:
     * @param "Body" (optional.Interface of []BulkUserCreate) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return JobId
*/

type WorkdayImportApiWorkdaysImportOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *WorkdayImportApiService) WorkdaysImport(ctx context.Context, workdayId string, localVarOptionals *WorkdayImportApiWorkdaysImportOpts) (JobId, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param id
 * @param jobId
 * @param optional nil or *WorkdayImportApiWorkdaysImportresultsOpts - Optional Parameters:
...
type WorkdayImportApiWorkdaysImportresultsOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *WorkdayImportApiService) WorkdaysImportresults(ctx context.Context, id string, jobId string, localVarOptionals *WorkdayImportApiWorkdaysImportresultsOpts) ([]JobWorkresult, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *WorkdayImportApiWorkdaysListOpts - Optional Parameters:
...
type WorkdayImportApiWorkdaysListOpts struct {
...
func (a *WorkdayImportApiService) WorkdaysList(ctx context.Context, localVarOptionals *WorkdayImportApiWorkdaysListOpts) ([]WorkdayOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *WorkdayImportApiWorkdaysPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of WorkdayInput) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return WorkdayOutput
*/

type WorkdayImportApiWorkdaysPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *WorkdayImportApiService) WorkdaysPost(ctx context.Context, localVarOptionals *WorkdayImportApiWorkdaysPostOpts) (WorkdayOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *WorkdayImportApiWorkdaysPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of WorkdayFields) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return WorkdayOutput
*/

type WorkdayImportApiWorkdaysPutOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *WorkdayImportApiService) WorkdaysPut(ctx context.Context, id string, localVarOptionals *WorkdayImportApiWorkdaysPutOpts) (WorkdayOutput, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param workdayId
 * @param optional nil or *WorkdayImportApiWorkdaysWorkersOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Sort" (optional.Interface of []string) -  The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending. 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
...
type WorkdayImportApiWorkdaysWorkersOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    Sort optional.Interface
    XOrgId optional.String
...
func (a *WorkdayImportApiService) WorkdaysWorkers(ctx context.Context, workdayId string, localVarOptionals *WorkdayImportApiWorkdaysWorkersOpts) ([]WorkdayWorker, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
