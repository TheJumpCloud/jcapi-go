 ...
 * @param optional nil or *RADIUSServersApiGraphRadiusServerAssociationsListOpts - Optional Parameters:
...
type RADIUSServersApiGraphRadiusServerAssociationsListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *RADIUSServersApiService) GraphRadiusServerAssociationsList(ctx context.Context, radiusserverId string, targets []string, localVarOptionals *RADIUSServersApiGraphRadiusServerAssociationsListOpts) ([]GraphConnection, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param radiusserverId ObjectID of the Radius Server.
 * @param optional nil or *RADIUSServersApiGraphRadiusServerAssociationsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationRadiusServer) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type RADIUSServersApiGraphRadiusServerAssociationsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *RADIUSServersApiService) GraphRadiusServerAssociationsPost(ctx context.Context, radiusserverId string, localVarOptionals *RADIUSServersApiGraphRadiusServerAssociationsPostOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param radiusserverId ObjectID of the Radius Server.
 * @param optional nil or *RADIUSServersApiGraphRadiusServerTraverseUserOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
...
type RADIUSServersApiGraphRadiusServerTraverseUserOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
...
func (a *RADIUSServersApiService) GraphRadiusServerTraverseUser(ctx context.Context, radiusserverId string, localVarOptionals *RADIUSServersApiGraphRadiusServerTraverseUserOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param radiusserverId ObjectID of the Radius Server.
 * @param optional nil or *RADIUSServersApiGraphRadiusServerTraverseUserGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type RADIUSServersApiGraphRadiusServerTraverseUserGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *RADIUSServersApiService) GraphRadiusServerTraverseUserGroup(ctx context.Context, radiusserverId string, localVarOptionals *RADIUSServersApiGraphRadiusServerTraverseUserGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
