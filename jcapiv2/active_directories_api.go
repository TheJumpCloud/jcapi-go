...
type ActiveDirectoriesApi struct {
	Configuration *Configuration
}

func NewActiveDirectoriesApi() *ActiveDirectoriesApi {
	configuration := NewConfiguration()
	return &ActiveDirectoriesApi{
		Configuration: configuration,
	}
}

func NewActiveDirectoriesApiWithBasePath(basePath string) *ActiveDirectoriesApi {
	configuration := NewConfiguration()
 ...
 * @return void
 */
func (a ActiveDirectoriesApi) ActivedirectoriesDelete(id string, contentType string, accept string) (*APIResponse, error) {
 ...
 */
func (a ActiveDirectoriesApi) ActivedirectoriesGet(id string, contentType string, accept string) (*ActiveDirectoryOutput, *APIResponse, error) {
 ...
 * @return []ActiveDirectoryOutput
 */
func (a ActiveDirectoriesApi) ActivedirectoriesList(contentType string, accept string, fields string, filter string, limit int32, skip int32, sort string) ([]ActiveDirectoryOutput, *APIResponse, error) {
 ...
 * @return *ActiveDirectoryOutput
 */
func (a ActiveDirectoriesApi) ActivedirectoriesPost(contentType string, accept string, body ActiveDirectoryInput) (*ActiveDirectoryOutput, *APIResponse, error) {
 ...
 */
func (a ActiveDirectoriesApi) GraphActiveDirectoryAssociationsList(activedirectoryId string, targets []string, contentType string, accept string, limit int32, skip int32) ([]GraphConnection, *APIResponse, error) {
 ...
 * @return void
 */
func (a ActiveDirectoriesApi) GraphActiveDirectoryAssociationsPost(activedirectoryId string, contentType string, accept string, body GraphManagementReq) (*APIResponse, error) {
 ...
 */
func (a ActiveDirectoriesApi) GraphActiveDirectoryTraverseUserGroup(activedirectoryId string, contentType string, accept string, limit int32, skip int32) ([]GraphObjectWithPaths, *APIResponse, error) {
