 ...
 * @param optional nil or *SambaDomainsApiLdapserversSambaDomainsDeleteOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return string
*/

type SambaDomainsApiLdapserversSambaDomainsDeleteOpts struct {
    XOrgId optional.String
}

func (a *SambaDomainsApiService) LdapserversSambaDomainsDelete(ctx context.Context, ldapserverId string, id string, localVarOptionals *SambaDomainsApiLdapserversSambaDomainsDeleteOpts) (string, *http.Response, error) {
	var (
 ...
 * @param ldapserverId Unique identifier of the LDAP server.
 * @param id Unique identifier of the samba domain.
 * @param optional nil or *SambaDomainsApiLdapserversSambaDomainsGetOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return SambaDomainOutput
*/

type SambaDomainsApiLdapserversSambaDomainsGetOpts struct {
    XOrgId optional.String
}

func (a *SambaDomainsApiService) LdapserversSambaDomainsGet(ctx context.Context, ldapserverId string, id string, localVarOptionals *SambaDomainsApiLdapserversSambaDomainsGetOpts) (SambaDomainOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SambaDomainOutput
	)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ldapserverId Unique identifier of the LDAP server.
 * @param optional nil or *SambaDomainsApiLdapserversSambaDomainsListOpts - Optional Parameters:
...
type SambaDomainsApiLdapserversSambaDomainsListOpts struct {
...
func (a *SambaDomainsApiService) LdapserversSambaDomainsList(ctx context.Context, ldapserverId string, localVarOptionals *SambaDomainsApiLdapserversSambaDomainsListOpts) ([]SambaDomainOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ldapserverId Unique identifier of the LDAP server.
 * @param optional nil or *SambaDomainsApiLdapserversSambaDomainsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SambaDomainInput) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return SambaDomainOutput
*/

type SambaDomainsApiLdapserversSambaDomainsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *SambaDomainsApiService) LdapserversSambaDomainsPost(ctx context.Context, ldapserverId string, localVarOptionals *SambaDomainsApiLdapserversSambaDomainsPostOpts) (SambaDomainOutput, *http.Response, error) {
	var (
 ...
 * @param ldapserverId Unique identifier of the LDAP server.
 * @param id Unique identifier of the samba domain.
 * @param optional nil or *SambaDomainsApiLdapserversSambaDomainsPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SambaDomainInput) - 
@return SambaDomainOutput
*/

type SambaDomainsApiLdapserversSambaDomainsPutOpts struct {
    Body optional.Interface
}

func (a *SambaDomainsApiService) LdapserversSambaDomainsPut(ctx context.Context, ldapserverId string, id string, localVarOptionals *SambaDomainsApiLdapserversSambaDomainsPutOpts) (SambaDomainOutput, *http.Response, error) {
	var (
