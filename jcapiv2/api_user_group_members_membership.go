 ...
 * @param optional nil or *UserGroupMembersMembershipApiGraphUserGroupMembersListOpts - Optional Parameters:
...
type UserGroupMembersMembershipApiGraphUserGroupMembersListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *UserGroupMembersMembershipApiService) GraphUserGroupMembersList(ctx context.Context, groupId string, localVarOptionals *UserGroupMembersMembershipApiGraphUserGroupMembersListOpts) ([]GraphConnection, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the User Group.
 * @param optional nil or *UserGroupMembersMembershipApiGraphUserGroupMembersPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationUserGroupMember) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type UserGroupMembersMembershipApiGraphUserGroupMembersPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *UserGroupMembersMembershipApiService) GraphUserGroupMembersPost(ctx context.Context, groupId string, localVarOptionals *UserGroupMembersMembershipApiGraphUserGroupMembersPostOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the User Group.
 * @param optional nil or *UserGroupMembersMembershipApiGraphUserGroupMembershipOpts - Optional Parameters:
...
type UserGroupMembersMembershipApiGraphUserGroupMembershipOpts struct {
...
func (a *UserGroupMembersMembershipApiService) GraphUserGroupMembership(ctx context.Context, groupId string, localVarOptionals *UserGroupMembersMembershipApiGraphUserGroupMembershipOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
