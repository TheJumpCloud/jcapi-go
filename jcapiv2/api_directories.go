...
/*
DirectoriesApiService List All Directories
 ...
 * @param optional nil or *DirectoriesApiDirectoriesListOpts - Optional Parameters:
...
type DirectoriesApiDirectoriesListOpts struct {
...
func (a *DirectoriesApiService) DirectoriesList(ctx context.Context, localVarOptionals *DirectoriesApiDirectoriesListOpts) ([]Directory, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/directories"
