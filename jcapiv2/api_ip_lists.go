...
type IPListsApiService service
/*
IPListsApiService Delete an IP list
 ...
 * @param id
 * @param optional nil or *IPListsApiIplistsDeleteOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return IpList
*/

type IPListsApiIplistsDeleteOpts struct {
    XOrgId optional.String
}

func (a *IPListsApiService) IplistsDelete(ctx context.Context, id string, localVarOptionals *IPListsApiIplistsDeleteOpts) (IpList, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/iplists/{id}"
...
/*
IPListsApiService Get an IP list
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *IPListsApiIplistsGetOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return IpList
*/

type IPListsApiIplistsGetOpts struct {
    XOrgId optional.String
}

func (a *IPListsApiService) IplistsGet(ctx context.Context, id string, localVarOptionals *IPListsApiIplistsGetOpts) (IpList, *http.Response, error) {
	var (
...
/*
IPListsApiService List IP Lists
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *IPListsApiIplistsListOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
...
type IPListsApiIplistsListOpts struct {
    XOrgId optional.String
...
func (a *IPListsApiService) IplistsList(ctx context.Context, localVarOptionals *IPListsApiIplistsListOpts) ([]IpList, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/iplists"
...
/*
IPListsApiService Update an IP list
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *IPListsApiIplistsPatchOpts - Optional Parameters:
     * @param "Body" (optional.Interface of IpListRequest) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return IpList
*/

type IPListsApiIplistsPatchOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *IPListsApiService) IplistsPatch(ctx context.Context, id string, localVarOptionals *IPListsApiIplistsPatchOpts) (IpList, *http.Response, error) {
	var (
...
/*
IPListsApiService Create IP List
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *IPListsApiIplistsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of IpListRequest) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return IpList
*/

type IPListsApiIplistsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *IPListsApiService) IplistsPost(ctx context.Context, localVarOptionals *IPListsApiIplistsPostOpts) (IpList, *http.Response, error) {
	var (
...
/*
IPListsApiService Replace an IP list
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *IPListsApiIplistsPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of IpListRequest) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return IpList
*/

type IPListsApiIplistsPutOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *IPListsApiService) IplistsPut(ctx context.Context, id string, localVarOptionals *IPListsApiIplistsPutOpts) (IpList, *http.Response, error) {
	var (
