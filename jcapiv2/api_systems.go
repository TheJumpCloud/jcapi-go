 ...
 * @param optional nil or *SystemsApiGraphSystemAssociationsListOpts - Optional Parameters:
...
type SystemsApiGraphSystemAssociationsListOpts struct {
...
func (a *SystemsApiService) GraphSystemAssociationsList(ctx context.Context, systemId string, targets []string, localVarOptionals *SystemsApiGraphSystemAssociationsListOpts) ([]GraphConnection, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId ObjectID of the System.
 * @param optional nil or *SystemsApiGraphSystemAssociationsPostOpts - Optional Parameters:
...
type SystemsApiGraphSystemAssociationsPostOpts struct {
...
func (a *SystemsApiService) GraphSystemAssociationsPost(ctx context.Context, systemId string, localVarOptionals *SystemsApiGraphSystemAssociationsPostOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId ObjectID of the System.
 * @param optional nil or *SystemsApiGraphSystemMemberOfOpts - Optional Parameters:
...
type SystemsApiGraphSystemMemberOfOpts struct {
...
func (a *SystemsApiService) GraphSystemMemberOf(ctx context.Context, systemId string, localVarOptionals *SystemsApiGraphSystemMemberOfOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId ObjectID of the System.
 * @param optional nil or *SystemsApiGraphSystemTraverseCommandOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type SystemsApiGraphSystemTraverseCommandOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *SystemsApiService) GraphSystemTraverseCommand(ctx context.Context, systemId string, localVarOptionals *SystemsApiGraphSystemTraverseCommandOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId ObjectID of the System.
 * @param optional nil or *SystemsApiGraphSystemTraversePolicyOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type SystemsApiGraphSystemTraversePolicyOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *SystemsApiService) GraphSystemTraversePolicy(ctx context.Context, systemId string, localVarOptionals *SystemsApiGraphSystemTraversePolicyOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SystemsApiService List the Policy Groups bound to a System
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId ObjectID of the System.
 * @param optional nil or *SystemsApiGraphSystemTraversePolicyGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Date" (optional.String) -  Current date header for the System Context API
...
type SystemsApiGraphSystemTraversePolicyGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Date optional.String
...
func (a *SystemsApiService) GraphSystemTraversePolicyGroup(ctx context.Context, systemId string, localVarOptionals *SystemsApiGraphSystemTraversePolicyGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId ObjectID of the System.
 * @param optional nil or *SystemsApiGraphSystemTraverseUserOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Date" (optional.String) -  Current date header for the System Context API
...
type SystemsApiGraphSystemTraverseUserOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Date optional.String
...
func (a *SystemsApiService) GraphSystemTraverseUser(ctx context.Context, systemId string, localVarOptionals *SystemsApiGraphSystemTraverseUserOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId ObjectID of the System.
 * @param optional nil or *SystemsApiGraphSystemTraverseUserGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Date" (optional.String) -  Current date header for the System Context API
...
type SystemsApiGraphSystemTraverseUserGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Date optional.String
...
func (a *SystemsApiService) GraphSystemTraverseUserGroup(ctx context.Context, systemId string, localVarOptionals *SystemsApiGraphSystemTraverseUserGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId
 * @param optional nil or *SystemsApiSystemsGetFDEKeyOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return Systemfdekey
*/

type SystemsApiSystemsGetFDEKeyOpts struct {
    XOrgId optional.String
}

func (a *SystemsApiService) SystemsGetFDEKey(ctx context.Context, systemId string, localVarOptionals *SystemsApiSystemsGetFDEKeyOpts) (Systemfdekey, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SystemsApiService List the associated Software Application Statuses of a System
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param systemId ObjectID of the System.
 * @param optional nil or *SystemsApiSystemsListSoftwareAppsWithStatusesOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
...
type SystemsApiSystemsListSoftwareAppsWithStatusesOpts struct {
    XOrgId optional.String
    Filter optional.Interface
    Limit optional.Int32
    Skip optional.Int32
...
func (a *SystemsApiService) SystemsListSoftwareAppsWithStatuses(ctx context.Context, systemId string, localVarOptionals *SystemsApiSystemsListSoftwareAppsWithStatusesOpts) ([]SoftwareAppWithStatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/systems/{system_id}/softwareappstatuses"
	localVarPath = strings.Replace(localVarPath, "{"+"system_id"+"}", fmt.Sprintf("%v", systemId), -1)
