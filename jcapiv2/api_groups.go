 ...
 * @param optional nil or *GroupsApiGroupsListOpts - Optional Parameters:
     ...
     * @param "XUnfilteredTotalCount" (optional.Int32) -  If provided in the request with any non-empty value, this header will be returned on the response populated with the total count of objects without filters taken into account
@return []Group
*/
...
type GroupsApiGroupsListOpts struct {
    ...
    XUnfilteredTotalCount optional.Int32
}
...
func (a *GroupsApiService) GroupsList(ctx context.Context, localVarOptionals *GroupsApiGroupsListOpts) ([]Group, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.XUnfilteredTotalCount.IsSet() {
		localVarHeaderParams["x-unfiltered-total-count"] = parameterToString(localVarOptionals.XUnfilteredTotalCount.Value(), "")
	}
	if ctx != nil {
