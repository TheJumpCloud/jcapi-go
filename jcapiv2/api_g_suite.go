 ...
 * @param optional nil or *GSuiteApiGraphGSuiteAssociationsListOpts - Optional Parameters:
...
type GSuiteApiGraphGSuiteAssociationsListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *GSuiteApiService) GraphGSuiteAssociationsList(ctx context.Context, gsuiteId string, targets []string, localVarOptionals *GSuiteApiGraphGSuiteAssociationsListOpts) ([]GraphConnection, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param gsuiteId ObjectID of the G Suite instance.
 * @param optional nil or *GSuiteApiGraphGSuiteAssociationsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationGSuite) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type GSuiteApiGraphGSuiteAssociationsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *GSuiteApiService) GraphGSuiteAssociationsPost(ctx context.Context, gsuiteId string, localVarOptionals *GSuiteApiGraphGSuiteAssociationsPostOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param gsuiteId ObjectID of the G Suite instance.
 * @param optional nil or *GSuiteApiGraphGSuiteTraverseUserOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
...
type GSuiteApiGraphGSuiteTraverseUserOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
...
func (a *GSuiteApiService) GraphGSuiteTraverseUser(ctx context.Context, gsuiteId string, localVarOptionals *GSuiteApiGraphGSuiteTraverseUserOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param gsuiteId ObjectID of the G Suite instance.
 * @param optional nil or *GSuiteApiGraphGSuiteTraverseUserGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type GSuiteApiGraphGSuiteTraverseUserGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *GSuiteApiService) GraphGSuiteTraverseUserGroup(ctx context.Context, gsuiteId string, localVarOptionals *GSuiteApiGraphGSuiteTraverseUserGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *GSuiteApiGsuitesGetOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return GsuiteOutput
*/

type GSuiteApiGsuitesGetOpts struct {
    XOrgId optional.String
}

func (a *GSuiteApiService) GsuitesGet(ctx context.Context, id string, localVarOptionals *GSuiteApiGsuitesGetOpts) (GsuiteOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue GsuiteOutput
	)
...
/*
GSuiteApiService Get a list of users in Jumpcloud format to import from a Google Workspace account.
Lists available G Suite users for import, translated to the Jumpcloud user schema.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param gsuiteId
 * @param optional nil or *GSuiteApiGsuitesListImportJumpcloudUsersOpts - Optional Parameters:
...
type GSuiteApiGsuitesListImportJumpcloudUsersOpts struct {
...
func (a *GSuiteApiService) GsuitesListImportJumpcloudUsers(ctx context.Context, gsuiteId string, localVarOptionals *GSuiteApiGsuitesListImportJumpcloudUsersOpts) (InlineResponse2001, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
GSuiteApiService Get a list of users to import from a G Suite instance
Lists G Suite users available for import.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param gsuiteId
 * @param optional nil or *GSuiteApiGsuitesListImportUsersOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "MaxResults" (optional.Int32) -  Google Directory API maximum number of results per page. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
     * @param "OrderBy" (optional.String) -  Google Directory API sort field parameter. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
     * @param "PageToken" (optional.String) -  Google Directory API token used to access the next page of results. See https://developers.google.com/admin-sdk/directory/reference/rest/v1/users/list.
...
type GSuiteApiGsuitesListImportUsersOpts struct {
    Limit optional.Int32
    MaxResults optional.Int32
    OrderBy optional.String
    PageToken optional.String
...
func (a *GSuiteApiService) GsuitesListImportUsers(ctx context.Context, gsuiteId string, localVarOptionals *GSuiteApiGsuitesListImportUsersOpts) (InlineResponse2002, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Unique identifier of the GSuite.
 * @param optional nil or *GSuiteApiGsuitesPatchOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GsuitePatchInput) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return GsuiteOutput
*/

type GSuiteApiGsuitesPatchOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *GSuiteApiService) GsuitesPatch(ctx context.Context, id string, localVarOptionals *GSuiteApiGsuitesPatchOpts) (GsuiteOutput, *http.Response, error) {
	var (
...
*/
func (a *GSuiteApiService) TranslationRulesGSuiteDelete(ctx context.Context, gsuiteId string, id string) (*http.Response, error) {
	var (
...
*/
func (a *GSuiteApiService) TranslationRulesGSuiteGet(ctx context.Context, gsuiteId string, id string) (GSuiteTranslationRule, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param gsuiteId
 * @param optional nil or *GSuiteApiTranslationRulesGSuiteListOpts - Optional Parameters:
...
type GSuiteApiTranslationRulesGSuiteListOpts struct {
...
func (a *GSuiteApiService) TranslationRulesGSuiteList(ctx context.Context, gsuiteId string, localVarOptionals *GSuiteApiTranslationRulesGSuiteListOpts) ([]GSuiteTranslationRule, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param gsuiteId
 * @param optional nil or *GSuiteApiTranslationRulesGSuitePostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GSuiteTranslationRuleRequest) - 
@return GSuiteTranslationRule
*/

type GSuiteApiTranslationRulesGSuitePostOpts struct {
    Body optional.Interface
}

func (a *GSuiteApiService) TranslationRulesGSuitePost(ctx context.Context, gsuiteId string, localVarOptionals *GSuiteApiTranslationRulesGSuitePostOpts) (GSuiteTranslationRule, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
