...
/*
CommandsApiService Cancel all queued commands for an organization by workflow instance Id
 ...
 * @param optional nil or *CommandsApiCommandsCancelQueuedCommandsByWorkflowInstanceIdOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type CommandsApiCommandsCancelQueuedCommandsByWorkflowInstanceIdOpts struct {
    XOrgId optional.String
}

func (a *CommandsApiService) CommandsCancelQueuedCommandsByWorkflowInstanceId(ctx context.Context, workflowInstanceId string, localVarOptionals *CommandsApiCommandsCancelQueuedCommandsByWorkflowInstanceIdOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/commandqueue/{workflow_instance_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"workflow_instance_id"+"}", fmt.Sprintf("%v", workflowInstanceId), -1)
...
/*
CommandsApiService Fetch the queued Commands for an Organization
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CommandsApiCommandsGetQueuedCommandsByWorkflowOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
...
type CommandsApiCommandsGetQueuedCommandsByWorkflowOpts struct {
    XOrgId optional.String
...
func (a *CommandsApiService) CommandsGetQueuedCommandsByWorkflow(ctx context.Context, localVarOptionals *CommandsApiCommandsGetQueuedCommandsByWorkflowOpts) (QueuedCommandList, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/queuedcommand/workflows"
 ...
 * @param optional nil or *CommandsApiGraphCommandAssociationsListOpts - Optional Parameters:
...
type CommandsApiGraphCommandAssociationsListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *CommandsApiService) GraphCommandAssociationsList(ctx context.Context, commandId string, targets []string, localVarOptionals *CommandsApiGraphCommandAssociationsListOpts) ([]GraphConnection, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param commandId ObjectID of the Command.
 * @param optional nil or *CommandsApiGraphCommandAssociationsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationCommand) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type CommandsApiGraphCommandAssociationsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *CommandsApiService) GraphCommandAssociationsPost(ctx context.Context, commandId string, localVarOptionals *CommandsApiGraphCommandAssociationsPostOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param commandId ObjectID of the Command.
 * @param optional nil or *CommandsApiGraphCommandTraverseSystemOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type CommandsApiGraphCommandTraverseSystemOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *CommandsApiService) GraphCommandTraverseSystem(ctx context.Context, commandId string, localVarOptionals *CommandsApiGraphCommandTraverseSystemOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param commandId ObjectID of the Command.
 * @param optional nil or *CommandsApiGraphCommandTraverseSystemGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type CommandsApiGraphCommandTraverseSystemGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *CommandsApiService) GraphCommandTraverseSystemGroup(ctx context.Context, commandId string, localVarOptionals *CommandsApiGraphCommandTraverseSystemGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
