 ...
 * @param optional nil or *SystemGroupsApiGraphSystemGroupAssociationsListOpts - Optional Parameters:
...
type SystemGroupsApiGraphSystemGroupAssociationsListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *SystemGroupsApiService) GraphSystemGroupAssociationsList(ctx context.Context, groupId string, targets []string, localVarOptionals *SystemGroupsApiGraphSystemGroupAssociationsListOpts) ([]GraphConnection, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the System Group.
 * @param optional nil or *SystemGroupsApiGraphSystemGroupAssociationsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationSystemGroup) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.

*/

type SystemGroupsApiGraphSystemGroupAssociationsPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *SystemGroupsApiService) GraphSystemGroupAssociationsPost(ctx context.Context, groupId string, localVarOptionals *SystemGroupsApiGraphSystemGroupAssociationsPostOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the System Group.
 * @param optional nil or *SystemGroupsApiGraphSystemGroupMembersListOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return []GraphConnection
...
type SystemGroupsApiGraphSystemGroupMembersListOpts struct {
    Limit optional.Int32
    Skip optional.Int32
    XOrgId optional.String
}

func (a *SystemGroupsApiService) GraphSystemGroupMembersList(ctx context.Context, groupId string, localVarOptionals *SystemGroupsApiGraphSystemGroupMembersListOpts) ([]GraphConnection, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the System Group.
 * @param optional nil or *SystemGroupsApiGraphSystemGroupMembersPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GraphOperationSystemGroupMember) - 
...
type SystemGroupsApiGraphSystemGroupMembersPostOpts struct {
    Body optional.Interface
...
func (a *SystemGroupsApiService) GraphSystemGroupMembersPost(ctx context.Context, groupId string, localVarOptionals *SystemGroupsApiGraphSystemGroupMembersPostOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the System Group.
 * @param optional nil or *SystemGroupsApiGraphSystemGroupMembershipOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
...
type SystemGroupsApiGraphSystemGroupMembershipOpts struct {
    Limit optional.Int32
    Skip optional.Int32
...
func (a *SystemGroupsApiService) GraphSystemGroupMembership(ctx context.Context, groupId string, localVarOptionals *SystemGroupsApiGraphSystemGroupMembershipOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SystemGroupsApiService List the Policies bound to a System Group
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the System Group.
 * @param optional nil or *SystemGroupsApiGraphSystemGroupTraversePolicyOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type SystemGroupsApiGraphSystemGroupTraversePolicyOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *SystemGroupsApiService) GraphSystemGroupTraversePolicy(ctx context.Context, groupId string, localVarOptionals *SystemGroupsApiGraphSystemGroupTraversePolicyOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SystemGroupsApiService List the Policy Groups bound to a System Group
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the System Group.
 * @param optional nil or *SystemGroupsApiGraphSystemGroupTraversePolicyGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type SystemGroupsApiGraphSystemGroupTraversePolicyGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *SystemGroupsApiService) GraphSystemGroupTraversePolicyGroup(ctx context.Context, groupId string, localVarOptionals *SystemGroupsApiGraphSystemGroupTraversePolicyGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/systemgroups/{group_id}/policygroups"
	localVarPath = strings.Replace(localVarPath, "{"+"group_id"+"}", fmt.Sprintf("%v", groupId), -1)
...
/*
SystemGroupsApiService List the Users bound to a System Group
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the System Group.
 * @param optional nil or *SystemGroupsApiGraphSystemGroupTraverseUserOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type SystemGroupsApiGraphSystemGroupTraverseUserOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *SystemGroupsApiService) GraphSystemGroupTraverseUser(ctx context.Context, groupId string, localVarOptionals *SystemGroupsApiGraphSystemGroupTraverseUserOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SystemGroupsApiService List the User Groups bound to a System Group
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param groupId ObjectID of the System Group.
 * @param optional nil or *SystemGroupsApiGraphSystemGroupTraverseUserGroupOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  The number of records to return at once. Limited to 100.
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
     * @param "Skip" (optional.Int32) -  The offset into the records to return.
     * @param "Filter" (optional.Interface of []string) -  A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60;
...
type SystemGroupsApiGraphSystemGroupTraverseUserGroupOpts struct {
    Limit optional.Int32
    XOrgId optional.String
    Skip optional.Int32
    Filter optional.Interface
...
func (a *SystemGroupsApiService) GraphSystemGroupTraverseUserGroup(ctx context.Context, groupId string, localVarOptionals *SystemGroupsApiGraphSystemGroupTraverseUserGroupOpts) ([]GraphObjectWithPaths, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *SystemGroupsApiGroupsSystemDeleteOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return SystemGroup
*/

type SystemGroupsApiGroupsSystemDeleteOpts struct {
    XOrgId optional.String
}

func (a *SystemGroupsApiService) GroupsSystemDelete(ctx context.Context, id string, localVarOptionals *SystemGroupsApiGroupsSystemDeleteOpts) (SystemGroup, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id ObjectID of the System Group.
 * @param optional nil or *SystemGroupsApiGroupsSystemGetOpts - Optional Parameters:
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return SystemGroup
*/

type SystemGroupsApiGroupsSystemGetOpts struct {
    XOrgId optional.String
}

func (a *SystemGroupsApiService) GroupsSystemGet(ctx context.Context, id string, localVarOptionals *SystemGroupsApiGroupsSystemGetOpts) (SystemGroup, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SystemGroupsApiGroupsSystemListOpts - Optional Parameters:
...
type SystemGroupsApiGroupsSystemListOpts struct {
...
func (a *SystemGroupsApiService) GroupsSystemList(ctx context.Context, localVarOptionals *SystemGroupsApiGroupsSystemListOpts) ([]SystemGroup, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SystemGroupsApiGroupsSystemPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SystemGroupData) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return SystemGroup
*/

type SystemGroupsApiGroupsSystemPostOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *SystemGroupsApiService) GroupsSystemPost(ctx context.Context, localVarOptionals *SystemGroupsApiGroupsSystemPostOpts) (SystemGroup, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id ObjectID of the System Group.
 * @param optional nil or *SystemGroupsApiGroupsSystemPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SystemGroupData) - 
     * @param "XOrgId" (optional.String) -  Organization identifier that can be obtained from console settings.
@return SystemGroup
*/

type SystemGroupsApiGroupsSystemPutOpts struct {
    Body optional.Interface
    XOrgId optional.String
}

func (a *SystemGroupsApiService) GroupsSystemPut(ctx context.Context, id string, localVarOptionals *SystemGroupsApiGroupsSystemPutOpts) (SystemGroup, *http.Response, error) {
	var (
