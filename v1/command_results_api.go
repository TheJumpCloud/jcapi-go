...
func (a *CommandResultsApiService) CommandResultsDelete(ctx context.Context, id string, contentType string, accept string, localVarOptionals map[string]interface{}) (Commandresult,  *http.Response, error) {
	var (
