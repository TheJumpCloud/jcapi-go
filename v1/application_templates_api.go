...
func (a *ApplicationTemplatesApiService) ApplicationTemplatesGet(ctx context.Context, id string, contentType string, accept string, localVarOptionals map[string]interface{}) (Applicationtemplate,  *http.Response, error) {
	var (
...
func (a *ApplicationTemplatesApiService) ApplicationTemplatesList(ctx context.Context, contentType string, accept string, localVarOptionals map[string]interface{}) (Applicationtemplateslist,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
