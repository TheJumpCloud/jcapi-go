 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "xOrgId" (string) 
 @return */
func (a *CommandTriggersApiService) CommandTriggerWebhookPost(ctx context.Context, triggername string, contentType string, accept string, localVarOptionals map[string]interface{}) ( *http.Response, error) {
	var (
