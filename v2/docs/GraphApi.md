...
> []GraphObjectWithPaths GraphActiveDirectoryTraverseUser(ctx, activedirectoryId, contentType, accept, optional)
...
> []GraphObjectWithPaths GraphUserTraverseActiveDirectory(ctx, userId, contentType, accept, optional)
