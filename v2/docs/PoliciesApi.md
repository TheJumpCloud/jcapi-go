...
# **PoliciesDelete**
> PoliciesDelete(ctx, id, contentType, accept, optional)
Deletes a Policy
...
# **PoliciesGet**
> PolicyWithDetails PoliciesGet(ctx, id, contentType, accept, optional)
...
# **PolicyresultsGet**
> PolicyResult PolicyresultsGet(ctx, id, contentType, accept, optional)
...
# **PolicystatusesList**
> []PolicyResult PolicystatusesList(ctx, systemId, contentType, accept, optional)
...
> []PolicyResult PolicystatusesList_0(ctx, policyId, contentType, accept, optional)
