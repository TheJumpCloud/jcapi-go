...
func (a *SystemsApiService) GraphSystemAssociationsList(ctx context.Context, systemId string, targets []string, contentType string, accept string, localVarOptionals map[string]interface{}) ([]GraphConnection,  *http.Response, error) {
	var (
...
/* SystemsApiService List the Policies associated with a System
...
/* SystemsApiService List the Users associated with a System
